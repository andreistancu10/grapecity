...
namespace DigitNow.Domain.DocumentManagement.Business.NotificationTypes.Commands.Update
{
    internal sealed class UpdateNotificationTypeHandler : ICommandHandler<UpdateNotificationTypeCommand, ResultObject>
    {
        ...
        public UpdateNotificationTypeHandler(DocumentManagementDbContext dbContext, IIdentityService identityService)
        {
