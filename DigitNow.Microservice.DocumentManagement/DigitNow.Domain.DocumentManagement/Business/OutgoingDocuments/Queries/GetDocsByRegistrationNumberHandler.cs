...
public class GetDocsByRegistrationNumberHandler : IQueryHandler<GetOutgoingByRegistrationNumberAndYearQuery, List<GetDocsByRegistrationNumberResponse>>
{
    ...
    public async Task<List<GetDocsByRegistrationNumberResponse>> Handle(GetOutgoingByRegistrationNumberAndYearQuery request, CancellationToken cancellationToken)
    {
