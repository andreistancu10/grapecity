...
namespace DigitNow.Domain.DocumentManagement.Business.PerformanceIndicators.Commands
{
    public class UpdatePerformanceIndicatorCommand : ICommand<ResultObject>
    {
