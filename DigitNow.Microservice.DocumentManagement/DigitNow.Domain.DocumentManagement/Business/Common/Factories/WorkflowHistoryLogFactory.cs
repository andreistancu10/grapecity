...
namespace DigitNow.Domain.DocumentManagement.Business.Common.Factories
{
    ...
    {
        public static WorkflowHistoryLog Create(long documentId, RecipientType role, User user, DocumentStatus documentStatus, string declineReason = default, string remarks = default, DateTime? opinionRequestedUntil = null, int? resolution = null)
