...
{
    public class CreatePublicAcquisitionProjectValidator : AbstractValidator<CreatePublicAcquisitionProjectRequest>
    {
        public CreatePublicAcquisitionProjectValidator()
        {
