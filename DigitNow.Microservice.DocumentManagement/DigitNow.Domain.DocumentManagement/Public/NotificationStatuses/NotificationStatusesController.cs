...
using DigitNow.Domain.DocumentManagement.Business.NotificationStatuses.Queries.GetById;
using DigitNow.Domain.DocumentManagement.Business.NotificationStatuses.Queries.GetList;
...
namespace DigitNow.Domain.DocumentManagement.Public.NotificationStatuses
{
    [Authorize]
    [ApiController]
