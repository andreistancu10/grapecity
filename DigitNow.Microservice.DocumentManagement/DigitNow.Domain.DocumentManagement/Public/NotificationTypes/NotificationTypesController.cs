...
using DigitNow.Domain.DocumentManagement.Business.NotificationTypes.Queries.GetById;
using DigitNow.Domain.DocumentManagement.Business.NotificationTypes.Queries.GetCategories;
using DigitNow.Domain.DocumentManagement.Business.NotificationTypes.Queries.GetEntityTypes;
using DigitNow.Domain.DocumentManagement.Business.NotificationTypes.Queries.GetList;
using DigitNow.Domain.DocumentManagement.Business.NotificationTypes.Queries.GetListByStatus;
...
namespace DigitNow.Domain.DocumentManagement.Public.NotificationTypes
{
    [Authorize]
    [ApiController]
