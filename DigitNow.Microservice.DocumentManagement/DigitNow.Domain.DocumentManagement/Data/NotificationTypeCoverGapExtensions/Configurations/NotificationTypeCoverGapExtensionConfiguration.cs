...
namespace DigitNow.Domain.DocumentManagement.Data.NotificationTypeCoverGapExtensions.Configurations
{
    public class NotificationTypeCoverGapExtensionConfiguration : IEntityTypeConfiguration<NotificationTypeCoverGapExtension>
    {
        ...
        {
            builder.ToTable(nameof(NotificationTypeCoverGapExtension), DocumentManagementDbContext.Schema);
