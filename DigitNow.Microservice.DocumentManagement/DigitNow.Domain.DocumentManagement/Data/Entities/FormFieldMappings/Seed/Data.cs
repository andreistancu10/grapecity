namespace DigitNow.Domain.DocumentManagement.Data.Entities.Seed
{
    ...
    {
        public static IEnumerable<FormFieldMapping> GetFormFieldMappings()
        {
        ...
        private static FormFieldMapping Create(long id, string key, string label, string context, int order, bool required, string initialValue, long formId, long formFieldId) =>
            new(id)
            {
                Key = key,
                Label = label,
