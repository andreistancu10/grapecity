...
namespace DigitNow.Adapters.MS.Catalog
{
    ...
    public class CatalogAdapterClient : ICatalogAdapterClient
    {
        ...
        public Task<DocumentType> GetDocumentTypeById(int id, CancellationToken cancellationToken) => _catalogHttpClient.GetAsync<DocumentType>($"DocumentTypes/{id}", cancellationToken);
